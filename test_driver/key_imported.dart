  ...
  group(
    ...
    () {
      ...
      test(
        ...
        () async {
          await driver.runUnsynchronized(() async {
            ...
            expect(
              await driver.getText(find.text('Deutsche eMark Testnet')),
              'Deutsche eMark Testnet',
            );
            expect(
              await driver.getText(find.text('Deutsche eMark')),
              'Deutsche eMark',
            );
          });
        },
      ...
      test('Wallets, try reset', () async {
        ...
        await driver.tap(find.pageBack());
        await driver.runUnsynchronized(() async {
          await driver.waitFor(find.text('Deutsche eMark Wallet'));
        });
      });
    },
    onPlatform: {
